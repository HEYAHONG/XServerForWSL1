...
tie %Config, 'Config', {
    archlibexp => '/usr/lib/perl5/5.32/i686-cygwin-threads-64int',
    ...
    path_sep => ':',
    privlibexp => '/usr/share/perl5/5.32',
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/local/lib/perl5/site_perl/5.32/i686-cygwin-threads-64int',
    sitelibexp => '/usr/local/share/perl5/site_perl/5.32',
    so => 'dll',
    useithreads => 'define',
