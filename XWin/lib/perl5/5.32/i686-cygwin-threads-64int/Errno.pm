...
"i686-cygwin-threads-64int-multi-3.2.0(0.34053)" or
	die "Errno architecture (i686-cygwin-threads-64int-multi-3.2.0(0.34053)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
